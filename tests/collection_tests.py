...
class TestCollection(object):
    ...
    def test_show_all_with_artist(self):
        ...
        all_albums = self.parser.collection.album_count(artist=self.show_artist)
    ...
    def test_played_with_artist(self):
        ...
        output = self.call_command(command_str)
        output_pieces = output.split('\n')
        played_count = self.parser.collection.album_count(artist=self.show_artist,
                                                            played=True,
                                                            unplayed=False)
    ...
    def test_unplayed_with_artist(self):
        ...
        output = self.call_command(command_str)
        output_pieces = output.split('\n')
        unplayed_count = self.parser.collection.album_count(artist=self.show_artist,
                                                            played=False,
                                                            unplayed=True)
